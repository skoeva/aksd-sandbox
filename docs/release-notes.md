...
Projects are detailed [here](https://learn.microsoft.com/en-us/azure/aks/aks-desktop-app?tabs=azure-subscription%2Caks-managed-project%2Ccontainer-image#create-a-new-project-in-aks-desktop).
