...
issues](https://github.com/Azure/aks-desktop/issues) before filing new issues to avoid
duplicates. For new issues, [file your bug or suggestion](https://github.com/Azure/aks-desktop/issues/new/choose)
...
Support for Project AKS desktop is limited to the resources listed above and is [**not** covered
