        ...
        {hpaInfo ? (
          <>
            ...
            <TextField
              ...
              onChange={e =>
                onEditValuesChange(v => ({ ...v, maxReplicas: parseInt(e.target.value, 10) || 0 }))
              }
              sx={{ mb: 2 }}
            ...
            <TextField
              ...
              onChange={e =>
                onEditValuesChange(v => ({ ...v, targetCPU: parseInt(e.target.value, 10) || 0 }))
              }
          ...
          <TextField
            ...
            onChange={e =>
              onEditValuesChange(v => ({ ...v, replicas: parseInt(e.target.value, 10) || 0 }))
            }
            sx={{ mt: 2 }}
            inputProps={{ min: 0 }}
